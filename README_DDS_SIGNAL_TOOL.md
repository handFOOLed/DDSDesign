...
- `DESIGN_REPORT_CN.md`：完整设计报告，包含总体方案、硬件、软件、算法和需求映射。
- `HARDWARE_DESIGN_CN.md`：硬件结构、AD9833、幅度控制、SCAN/COL 前端设计。
- `BOM_AND_INTERFACE_CN.md`：BOM、引脚表、串口命令表、可调参数。
- `ACCEPTANCE_TEST_CN.md`：GEN/SCAN/COL 验收步骤和常见问题。
- `CUBEMX_REGENERATION_CN.md`：CubeMX 重新生成代码后的检查项。
